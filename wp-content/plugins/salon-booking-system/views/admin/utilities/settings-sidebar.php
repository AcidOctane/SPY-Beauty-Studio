<div class="sln-admin-sidebar mobile">
	...
	<div class="sln-admin-banner">
		<div class="sln-admin-banner-content">
			...
			<h3><?php echo __('Enable online payments with PayPal, Stripes and other payment gateways.', 'salon-booking-system') ?></h3>
			<h2><?php echo __('Switch to a', 'salon-booking-system') ?> <strong><?php echo __('PRO VERSION', 'salon-booking-system') ?></strong> <?php echo __('for just 69€/year.', 'salon-booking-system') ?></h2>
			<a href="https://www.salonbookingsystem.com/salon-booking-plugin-pricing/" class="sln-btn sln-btn--banner sln-btn--big" target="_blank"><?php echo __('GET PRO VERSION', 'salon-booking-system') ?></a>
