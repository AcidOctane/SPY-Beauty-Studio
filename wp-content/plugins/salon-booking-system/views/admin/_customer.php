		...
		<input type="hidden" name="id" id="id" value="<?php echo $customer->getId(); ?>">
			<div class="sln-box sln-box--main">
				...
				<div class="row">
					...
					<?php 
					$additional_fields = SLN_Enum_CheckoutFields::toArray('customer');
					if($additional_fields){
					$helper = new SLN_Metabox_Helper();
					foreach ($additional_fields  as $field => $label) {
						$value = !$customer->getMeta($field) && isset(SLN_Enum_CheckoutFields::$additional_fields_defaults[$field])  ? SLN_Enum_CheckoutFields::$additional_fields_defaults[$field] : $customer->getMeta($field) ;
					 ...
					 ?>
					 <div class="col-xs-12 form-group sln_meta_field sln-input--simple <?php echo isset(SLN_Enum_CheckoutFields::$additional_fields_types[$field]) ? 'sln-'.SLN_Enum_CheckoutFields::$additional_fields_types[$field] : '' ?>">
						<label for="<?php echo 'sln_customer_meta[_sln_'.$field.']' ?>"><?php echo $label ?></label>
                        <?php 
