...
$holidays_rules = $plugin->getSettings()->getDailyHolidayItems();
?>
...
<div class="row sln-calendar-view sln-box">
    <div class="col-xs-12 col-lg-6">
        <div class="row cal-day-filter">
            <div class="col-xs-12 col-md-6 sln-select sln-select2-selection__search-primary form-group">
                <select id="sln-calendar-user-field"
                        data-nomatches="<?php _e('no users found','salon-booking-system')?>"
                        data-placeholder="<?php _e('digit a customer name', 'salon-booking-system')?>"
                        class="form-control">
                </select>
            </div>
            <div class="col-xs-12 col-md-6 sln-select sln-select--multiple form-group">
                <?php
