...
<div class="sln-separator"></div>
    <div class="row">
        ...
        if($additional_fields){
            ...
            $is_customer_field = in_array($field,array_keys(SLN_Enum_CheckoutFields::toArray('customer')));
            $value =  $is_customer_field  ? ( 
              ...
              ?>
                <div class="col-xs-12 col-md-<?php echo $width ?> sln-input--simple <?php echo isset(SLN_Enum_CheckoutFields::$additional_fields_types[$field]) ? 'sln-'.SLN_Enum_CheckoutFields::$additional_fields_types[$field] : '' ?>">
