...
<?php if (!is_user_logged_in()): ?>
    ...
    <div class="col-xs-12 col-md-8">
        <div class="row">
            <?php 
            $fields = $plugin->getSettings()->get('enabled_force_guest_checkout') ? array_merge(SLN_Enum_CheckoutFields::toArray('defaults'),SLN_Enum_CheckoutFields::toArray('not-customer')) : SLN_Enum_CheckoutFields::toArrayFull();
            foreach ($fields as $field => $label):  ?>
                ...
                $value = !$bb->get($field) && isset(SLN_Enum_CheckoutFields::$additional_fields_defaults[$field])  ? SLN_Enum_CheckoutFields::$additional_fields_defaults[$field] : $bb->get($field) ;
...
call_user_func_array(array('SLN_Form',$method_name), $additional_opts );
    ...
    <div class="row">
            <?php $fields = $plugin->getSettings()->get('enabled_force_guest_checkout') ? array_merge(SLN_Enum_CheckoutFields::toArray('defaults'),SLN_Enum_CheckoutFields::toArray('not-customer')) : SLN_Enum_CheckoutFields::toArrayFull();
            foreach ($fields as $field => $label):   ?>
                <?php if(SLN_Enum_CheckoutFields::isHidden($field)) {
                    SLN_Form::fieldText(
                        "sln[{$field}]",
