<table width="100%" cellspacing="0" cellpadding="0" border="0">
    ...
    <tr>
	<td align="left" valign="top" style="font-size:14px;line-height:18px;color:#979797;font-weight:500;font-family: 'Avenir-Medium',sans-serif,arial;">
	    <a href="mail-to:<?php echo $plugin->getSettings()->getSalonEmail() ?>" target="_blank" style="text-decoration:underline;color:#979797;"><?php echo $plugin->getSettings()->getSalonEmail() ?></a>
	</td>
    </tr>
</table>