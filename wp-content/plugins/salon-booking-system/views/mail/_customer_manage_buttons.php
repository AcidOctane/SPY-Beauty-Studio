<table width="148" cellspacing="0" cellpadding="0" border="0">
	...
	<td align="center" valign="top">
		...
		<?php } ?>
		    ...
		    <?php if($plugin->getSettings()->get('cancellation_enabled') && !$booking->hasStatus(SLN_Enum_BookingStatus::CANCELED) && is_object($customer)) : ?>
			<tr>
			    <td align="center" valign="top">
				<table width="148" border="0" cellpadding="0" cellspacing="0">
				    <tbody>
					<tr>
						...
						<a href="<?php echo home_url() . '?sln_customer_login=' . $customer->getHash(); ?>" target="_blank"  style="font-size:12px;line-height:20px;color:#fefefe;font-weight:bold;font-family: 'Avenir-Medium',sans-serif,arial;padding:0;margin:0;text-decoration:none;cursor:pointer;">
