...
class SLN_Helper_CalendarLink
{
	...
	$from = DateTime::createFromFormat('Y-m-d H:i', $booking->getStartsAt()->format('Y-m-d H:i'), new DateTimeZone($localTimezone));
	$to   = DateTime::createFromFormat('Y-m-d H:i', $booking->getEndsAt()->format('Y-m-d H:i'), new DateTimeZone($localTimezone));
