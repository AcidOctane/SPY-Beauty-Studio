...
abstract class SLN_Shortcode_Salon_AbstractUserStep extends SLN_Shortcode_Salon_Step
{
    protected function successRegistration($values){
        ...
        $additional_fields = array_keys( SLN_Enum_CheckoutFields::toArray('customer'));
    ...
    {
        $bb     = $this->getPlugin()->getBookingBuilder();
        $fields = array_keys(array_merge(SLN_Enum_CheckoutFields::toArray('defaults'),SLN_Enum_CheckoutFields::toArray('not-customer')));
