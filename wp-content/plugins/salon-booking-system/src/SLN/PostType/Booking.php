...
//        add_filter('wp_insert_post_data', array($this, 'insert_post_data'), '99', 2);
    ...
    public function posts_join ( $join, $wp_query ) {
        ...
        if ( is_admin() && 'edit.php' === $pagenow && $this->getPostType() === $_GET['post_type'] && ! empty( $_GET['s'] ) && ( isset($wp_query->query_vars['post_type'] )&& $wp_query->query_vars['post_type'] === $this->getPostType() )) {
